# Contributing to iis-expressify

First and foremost, thank you! We appreciate that you want to contribute to iis-expressify, your time is valuable, and your contributions mean a lot to us.
...
**Showing support for iis-expressify**

Please keep in mind that open source software is built by people like you, who spend their free time creating things the rest the community can use.

Don't have time to contribute? No worries, here are some other ways to show your support for iis-expressify:

- star the [project](https://github.com/joncloud/iis-expressify)
- tweet your support for iis-expressify
...
- **version**: (required) please note the version of iis-expressify are you using
...
The original poster or the maintainers of iis-expressify may close an issue at any time. Typically, but not exclusively, issues are closed when:
...
[so]: http://stackoverflow.com/questions/tagged/iis-expressify
